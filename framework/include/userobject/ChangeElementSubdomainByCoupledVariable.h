...
class ChangeElementSubdomainByCoupledVariable : public ChangeElementSubdomainUserObjectBase
{
public:
  static InputParameters validParams();

  ChangeElementSubdomainByCoupledVariable(const InputParameters & parameters);
  ...
  {
    return !shouldChangeSubdomainFromOriginToTarget();
  }
