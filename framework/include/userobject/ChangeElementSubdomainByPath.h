...
class ChangeElementSubdomainByPath : public ChangeElementSubdomainUserObjectBase
{
public:
  static InputParameters validParams();

  ChangeElementSubdomainByPath(const InputParameters & parameters);

  virtual bool shouldChangeSubdomainFromOriginToTarget() override;

  virtual bool shouldChangeSubdomainFromTargetToOrigin() override { return false; }
