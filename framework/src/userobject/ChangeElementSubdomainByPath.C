...
#include "ChangeElementSubdomainByPath.h"
#include "libmesh/point.h"

registerMooseObject("MooseApp", ChangeElementSubdomainByPath);

InputParameters
ChangeElementSubdomainByPath::validParams()
{
...
ChangeElementSubdomainByPath::ChangeElementSubdomainByPath(const InputParameters & parameters)
...
bool
ChangeElementSubdomainByPath::shouldChangeSubdomainFromOriginToTarget()
{
