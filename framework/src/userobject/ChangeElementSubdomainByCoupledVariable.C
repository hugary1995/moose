...
#include "ChangeElementSubdomainByCoupledVariable.h"

registerMooseObject("MooseApp", ChangeElementSubdomainByCoupledVariable);

InputParameters
ChangeElementSubdomainByCoupledVariable::validParams()
{
...
ChangeElementSubdomainByCoupledVariable::ChangeElementSubdomainByCoupledVariable(
...
bool
ChangeElementSubdomainByCoupledVariable::shouldChangeSubdomainFromOriginToTarget()
{
