...
XFEMAction::validParams()
{
  ...
  params.addRangeCheckedParam<Real>(
      ...
      0,
      "minimum_weight_multiplier >= 0 & minimum_weight_multiplier<=1",
      "Minimum average multiplier applied by XFEM to integration point weights for partial elements");
...
XFEMAction::act()
{
  ...
  if (_current_task == "setup_xfem")
  {
    ...
    xfem->setMinWeightMultiplier(getParam<Real>("minimum_weight_multiplier"));
  }
