...
[Variables]
  ...
  [c]
    [InitialCondition]
      ...
      inside = 0.5
      corners = '${a} ${fparse 0.25*ymax-0.01} 0 ${a} ${fparse 0.50*ymax-0.01} 0 ${a} ${fparse '
                '0.75*ymax-0.01} 0'
      opposite_corners = '${a} ${fparse 0.25*ymax+0.01} 0 ${a} ${fparse 0.50*ymax+0.01} 0 ${a} '
                         '${fparse 0.75*ymax+0.01} 0'
    []
  []
[]
...
[Materials]
  ...
  [pfbulkmat]
    ...
    prop_values = '0.05 0.01 0.015 ${fparse E_oxide/3/(1-2*nu_oxide)} ${fparse '
...
[Outputs]
  ...
  [exodus]
    type = Exodus
    file_base = 'output/plate_flat_large'
  []
[]
