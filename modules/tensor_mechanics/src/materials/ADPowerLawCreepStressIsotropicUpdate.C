...
#include "ADPowerLawCreepStressIsotropicUpdate.h"

registerMooseObject("TensorMechanicsApp", ADPowerLawCreepStressIsotropicUpdate);

InputParameters
ADPowerLawCreepStressIsotropicUpdate::validParams()
{
  InputParameters params = ADRadialReturnCreepStressIsotropicUpdateBase::validParams();
...
ADPowerLawCreepStressIsotropicUpdate::ADPowerLawCreepStressIsotropicUpdate(
    const InputParameters & parameters)
  : ADRadialReturnCreepStressIsotropicUpdateBase(parameters),
...
void
ADPowerLawCreepStressIsotropicUpdate::computeStressInitialize(
...
ADReal
ADPowerLawCreepStressIsotropicUpdate::computeResidual(const ADReal & effective_trial_stress,
                                                      const ADReal & scalar)
{
...
ADReal
ADPowerLawCreepStressIsotropicUpdate::computeDerivative(const ADReal & effective_trial_stress,
                                                        const ADReal & scalar)
{
  const ADReal stress_delta = effective_trial_stress - _three_shear_modulus * scalar;
...
ADReal
ADPowerLawCreepStressIsotropicUpdate::computeStrainEnergyRateDensity(
...
bool
ADPowerLawCreepStressIsotropicUpdate::substeppingCapabilityEnabled()
{
