...
#include "ADRadialReturnStressIsotropicUpdate.h"

#include "MooseMesh.h"
#include "ElasticityTensorTools.h"

InputParameters
ADRadialReturnStressIsotropicUpdate::validParams()
{
  InputParameters params = ADStressIsotropicUpdateBase::validParams();
...
ADRadialReturnStressIsotropicUpdate::ADRadialReturnStressIsotropicUpdate(
    const InputParameters & parameters)
  : ADStressIsotropicUpdateBase(parameters),
...
void
ADRadialReturnStressIsotropicUpdate::propagateQpStatefulPropertiesRadialReturn()
{
  _effective_inelastic_strain[_qp] = _effective_inelastic_strain_old[_qp];
}

int
ADRadialReturnStressIsotropicUpdate::calculateNumberSubsteps(
    const ADRankTwoTensor & strain_increment)
{
...
void
ADRadialReturnStressIsotropicUpdate::updateState(
    ADRankTwoTensor & strain_increment,
    ADRankTwoTensor & inelastic_strain_increment,
    const ADRankTwoTensor & /*rotation_increment*/,
    ADRankTwoTensor & stress_new,
    const RankTwoTensor & /*stress_old*/,
    const ADSymmetricIsotropicRankFourTensor & elasticity_tensor,
    const RankTwoTensor & elastic_strain_old)
{
  ...
  _three_shear_modulus = 1.5 * elasticity_tensor(1);
...
void
ADRadialReturnStressIsotropicUpdate::updateStateSubstep(
    ADRankTwoTensor & strain_increment,
    ADRankTwoTensor & inelastic_strain_increment,
    const ADRankTwoTensor & rotation_increment,
    ADRankTwoTensor & stress_new,
...
Real
ADRadialReturnStressIsotropicUpdate::computeReferenceResidual(
...
ADReal
ADRadialReturnStressIsotropicUpdate::maximumPermissibleValue(
...
Real
ADRadialReturnStressIsotropicUpdate::computeTimeStepLimit()
{
...
void
ADRadialReturnStressIsotropicUpdate::outputIterationSummary(std::stringstream * iter_output,
