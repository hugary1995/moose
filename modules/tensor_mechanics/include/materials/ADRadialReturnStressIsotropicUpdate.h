...
/**
 * ADRadialReturnStressIsotropicUpdate computes the radial return stress increment for
 ...
 * The stress increment computed by ADRadialReturnStressIsotropicUpdate is used by
 ...
 */
class ADRadialReturnStressIsotropicUpdate : public ADStressIsotropicUpdateBase,
                                            public ADSingleVariableReturnMappingSolution
{
public:
  static InputParameters validParams();

  ADRadialReturnStressIsotropicUpdate(const InputParameters & parameters);
...
protected:
   ...
   */
  virtual void
  computeStressInitialize(const ADReal & /*effective_trial_stress*/,
                          const ADSymmetricIsotropicRankFourTensor & /*elasticity_tensor*/)
  {
  }
