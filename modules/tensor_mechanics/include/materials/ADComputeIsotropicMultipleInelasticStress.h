...
class ADStressIsotropicUpdateBase;

/**
 * ADComputeIsotropicMultipleInelasticStress computes the stress and a decomposition of the strain
...
class ADComputeIsotropicMultipleInelasticStress : public ADComputeIsotropicFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  ADComputeIsotropicMultipleInelasticStress(const InputParameters & parameters);
...
protected:
   ...
   */
  std::vector<ADStressIsotropicUpdateBase *> _models;
