 ...
 */
class ADPowerLawCreepStressIsotropicUpdate : public ADRadialReturnCreepStressIsotropicUpdateBase
{
public:
  static InputParameters validParams();

  ADPowerLawCreepStressIsotropicUpdate(const InputParameters & parameters);
...
protected:
  ...
  computeStressInitialize(const ADReal & effective_trial_stress,
                          const ADSymmetricIsotropicRankFourTensor & elasticity_tensor) override;
