...
/**
 * ADStressIsotropicUpdateBase is a material that is not called by MOOSE because
 ...
 */
class ADStressIsotropicUpdateBase : public ADMaterial
{
public:
  static InputParameters validParams();

  ADStressIsotropicUpdateBase(const InputParameters & parameters);
