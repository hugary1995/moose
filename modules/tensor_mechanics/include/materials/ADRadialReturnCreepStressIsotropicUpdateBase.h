 ...
 */
class ADRadialReturnCreepStressIsotropicUpdateBase : public ADRadialReturnStressIsotropicUpdate
{
public:
  static InputParameters validParams();

  ADRadialReturnCreepStressIsotropicUpdateBase(const InputParameters & parameters);
